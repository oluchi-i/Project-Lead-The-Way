...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        AudioManager.Instance?.PlayMusic(AudioManager.MusicState.Gameplay);
    ...
    public void AdvanceCharacter()
    {
        ...
        if (result == StepResult.ReachedExit)
        {
            ...
            AudioManager.Instance?.PlayMusic(AudioManager.MusicState.Win);
        }
        else if (result == StepResult.Stuck)
        {
            ...
            // Fail SFX
            AudioManager.Instance?.PlaySFX_LevelFail();
        }
        else
        {
