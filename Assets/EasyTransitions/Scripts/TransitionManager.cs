...
#pragma warning disable 0649 // Unity assigns serialized fields from scenes/editor setup.
    ...
    {        
        ...
        private IEnumerator Start()
        {
            while (this.gameObject.activeInHierarchy)
            {
                ...
                var managerCount = GameObject.FindObjectsByType<TransitionManager>(FindObjectsInactive.Include).Length;
                if (managerCount > 1)
